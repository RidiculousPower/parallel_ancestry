...
module ::ParallelAncestry::Common::Bootstrap
  ...
  def create_parents( instance )
    ...
    return @parents_hash[ instance.__id__ ] = ::ParallelAncestry::Array::ParentsArray.new( nil, instance )
  ...
  def create_instance_parents( instance )
    ...
    return @instance_parents_hash[ instance.__id__ ] = ::ParallelAncestry::Array::InstanceParentsArray.new( nil, instance )
